...
/* The kernel tick, shared by the X1000 and the X1600.
 *
 * The tick runs on SYS_OST channel 1. There is no INTC source to unmask: the
 * OST reaches CP0 directly, on IP3 for the X1000 and IP4 for the X1600, and
 * that difference lives in each target's irq header rather than here.
 */
