 ...
 *
 ****************************************************************************/
#ifndef __HEADERGEN_X1600_UART_H__
#define __HEADERGEN_X1600_UART_H__

#include "macro.h"

#define REG_UART_URBR(_n1)  jz_reg(UART_URBR(_n1))
#define JA_UART_URBR(_n1)   (0xb0030000 + 0x0 + (_n1) * 0x1000)
...
#define JA_UART_UTHR(_n1)   (0xb0030000 + 0x0 + (_n1) * 0x1000)
...
#define JA_UART_UDLLR(_n1)  (0xb0030000 + 0x0 + (_n1) * 0x1000)
...
#define JA_UART_UDLHR(_n1)  (0xb0030000 + 0x4 + (_n1) * 0x1000)
...
#define JA_UART_UIER(_n1)           (0xb0030000 + 0x4 + (_n1) * 0x1000)
#define JT_UART_UIER(_n1)           JIO_32_RW
#define JN_UART_UIER(_n1)           UART_UIER
#define JI_UART_UIER(_n1)           (_n1)
#define BP_UART_UIER_RETOIE         5
#define BM_UART_UIER_RETOIE         0x20
#define BF_UART_UIER_RETOIE(v)      (((v) & 0x1) << 5)
#define BFM_UART_UIER_RETOIE(v)     BM_UART_UIER_RETOIE
#define BF_UART_UIER_RETOIE_V(e)    BF_UART_UIER_RETOIE(BV_UART_UIER_RETOIE__##e)
#define BFM_UART_UIER_RETOIE_V(v)   BM_UART_UIER_RETOIE
...
#define JA_UART_UIIR(_n1)                           (0xb0030000 + 0x8 + (_n1) * 0x1000)
...
#define BV_UART_UIIR_INID__RECEIVE_EMPTY_TIME_OUT   0x5
...
#define JA_UART_UFCR(_n1)           (0xb0030000 + 0x8 + (_n1) * 0x1000)
...
#define BV_UART_UFCR_RDTR__8BYTE    0x1
#define BV_UART_UFCR_RDTR__16BYTE   0x2
#define BV_UART_UFCR_RDTR__32BYTE   0x3
...
#define JA_UART_ULCR(_n1)               (0xb0030000 + 0xc + (_n1) * 0x1000)
...
#define JA_UART_UMCR(_n1)       (0xb0030000 + 0x10 + (_n1) * 0x1000)
...
#define JA_UART_ULSR(_n1)           (0xb0030000 + 0x14 + (_n1) * 0x1000)
...
#define JA_UART_UMSR(_n1)       (0xb0030000 + 0x18 + (_n1) * 0x1000)
...
#define JA_UART_USPR(_n1)   (0xb0030000 + 0x1c + (_n1) * 0x1000)
...
#define JA_UART_ISR(_n1)            (0xb0030000 + 0x20 + (_n1) * 0x1000)
...
#define JA_UART_UMR(_n1)    (0xb0030000 + 0x24 + (_n1) * 0x1000)
...
#define JA_UART_UACR(_n1)   (0xb0030000 + 0x28 + (_n1) * 0x1000)
...
#define JA_UART_URCR(_n1)   (0xb0030000 + 0x40 + (_n1) * 0x1000)
...
#define JA_UART_UTCR(_n1)   (0xb0030000 + 0x44 + (_n1) * 0x1000)
#define JT_UART_UTCR(_n1)   JIO_32_RW
#define JN_UART_UTCR(_n1)   UART_UTCR
#define JI_UART_UTCR(_n1)   (_n1)

#define REG_UART_URFCR(_n1)         jz_reg(UART_URFCR(_n1))
#define JA_UART_URFCR(_n1)          (0xb0030000 + 0x48 + (_n1) * 0x1000)
#define JT_UART_URFCR(_n1)          JIO_32_RW
#define JN_UART_URFCR(_n1)          UART_URFCR
#define JI_UART_URFCR(_n1)          (_n1)
#define BP_UART_URFCR_ETO_CNT       0
#define BM_UART_URFCR_ETO_CNT       0x7f
#define BF_UART_URFCR_ETO_CNT(v)    (((v) & 0x7f) << 0)
#define BFM_UART_URFCR_ETO_CNT(v)   BM_UART_URFCR_ETO_CNT
#define BF_UART_URFCR_ETO_CNT_V(e)  BF_UART_URFCR_ETO_CNT(BV_UART_URFCR_ETO_CNT__##e)
#define BFM_UART_URFCR_ETO_CNT_V(v) BM_UART_URFCR_ETO_CNT

#define REG_UART_URTDCR(_n1)        jz_reg(UART_URTDCR(_n1))
#define JA_UART_URTDCR(_n1)         (0xb0030000 + 0x50 + (_n1) * 0x1000)
#define JT_UART_URTDCR(_n1)         JIO_32_RW
#define JN_UART_URTDCR(_n1)         UART_URTDCR
#define JI_UART_URTDCR(_n1)         (_n1)
#define BP_UART_URTDCR_RTD_EN       7
#define BM_UART_URTDCR_RTD_EN       0x80
#define BF_UART_URTDCR_RTD_EN(v)    (((v) & 0x1) << 7)
#define BFM_UART_URTDCR_RTD_EN(v)   BM_UART_URTDCR_RTD_EN
#define BF_UART_URTDCR_RTD_EN_V(e)  BF_UART_URTDCR_RTD_EN(BV_UART_URTDCR_RTD_EN__##e)
#define BFM_UART_URTDCR_RTD_EN_V(v) BM_UART_URTDCR_RTD_EN
#define BP_UART_URTDCR_RTD_R        1
#define BM_UART_URTDCR_RTD_R        0x2
#define BF_UART_URTDCR_RTD_R(v)     (((v) & 0x1) << 1)
#define BFM_UART_URTDCR_RTD_R(v)    BM_UART_URTDCR_RTD_R
#define BF_UART_URTDCR_RTD_R_V(e)   BF_UART_URTDCR_RTD_R(BV_UART_URTDCR_RTD_R__##e)
#define BFM_UART_URTDCR_RTD_R_V(v)  BM_UART_URTDCR_RTD_R
#define BP_UART_URTDCR_RTD_T        0
#define BM_UART_URTDCR_RTD_T        0x1
#define BF_UART_URTDCR_RTD_T(v)     (((v) & 0x1) << 0)
#define BFM_UART_URTDCR_RTD_T(v)    BM_UART_URTDCR_RTD_T
#define BF_UART_URTDCR_RTD_T_V(e)   BF_UART_URTDCR_RTD_T(BV_UART_URTDCR_RTD_T__##e)
#define BFM_UART_URTDCR_RTD_T_V(v)  BM_UART_URTDCR_RTD_T

#endif /* __HEADERGEN_X1600_UART_H__*/
