 ...
 *
 ****************************************************************************/
#ifndef __HEADERGEN_X1600_SFC_H__
#define __HEADERGEN_X1600_SFC_H__
...
#define JI_SFC_GLB                  
#define BP_SFC_GLB_POLL_TIME        16
#define BM_SFC_GLB_POLL_TIME        0xffff0000
#define BF_SFC_GLB_POLL_TIME(v)     (((v) & 0xffff) << 16)
#define BFM_SFC_GLB_POLL_TIME(v)    BM_SFC_GLB_POLL_TIME
#define BF_SFC_GLB_POLL_TIME_V(e)   BF_SFC_GLB_POLL_TIME(BV_SFC_GLB_POLL_TIME__##e)
#define BFM_SFC_GLB_POLL_TIME_V(v)  BM_SFC_GLB_POLL_TIME
...
#define BP_SFC_GLB_DES_EN           15
#define BM_SFC_GLB_DES_EN           0x8000
#define BF_SFC_GLB_DES_EN(v)        (((v) & 0x1) << 15)
#define BFM_SFC_GLB_DES_EN(v)       BM_SFC_GLB_DES_EN
#define BF_SFC_GLB_DES_EN_V(e)      BF_SFC_GLB_DES_EN(BV_SFC_GLB_DES_EN__##e)
#define BFM_SFC_GLB_DES_EN_V(v)     BM_SFC_GLB_DES_EN
#define BP_SFC_GLB_CDT_EN           14
#define BM_SFC_GLB_CDT_EN           0x4000
#define BF_SFC_GLB_CDT_EN(v)        (((v) & 0x1) << 14)
#define BFM_SFC_GLB_CDT_EN(v)       BM_SFC_GLB_CDT_EN
#define BF_SFC_GLB_CDT_EN_V(e)      BF_SFC_GLB_CDT_EN(BV_SFC_GLB_CDT_EN__##e)
#define BFM_SFC_GLB_CDT_EN_V(v)     BM_SFC_GLB_CDT_EN
...
#define JA_SFC_DEV_PLUS(_n1)    (0xb3440000 + 0x48 + (_n1) * 0x4)
...
#define REG_SFC_CMD_IDX jz_reg(SFC_CMD_IDX)
#define JA_SFC_CMD_IDX  (0xb3440000 + 0x7c)
#define JT_SFC_CMD_IDX  JIO_32_RW
#define JN_SFC_CMD_IDX  SFC_CMD_IDX
#define JI_SFC_CMD_IDX  

#define REG_SFC_COL_ADDR    jz_reg(SFC_COL_ADDR)
#define JA_SFC_COL_ADDR     (0xb3440000 + 0x80)
#define JT_SFC_COL_ADDR     JIO_32_RW
#define JN_SFC_COL_ADDR     SFC_COL_ADDR
#define JI_SFC_COL_ADDR     

#define REG_SFC_ROW_ADDR    jz_reg(SFC_ROW_ADDR)
#define JA_SFC_ROW_ADDR     (0xb3440000 + 0x84)
#define JT_SFC_ROW_ADDR     JIO_32_RW
#define JN_SFC_ROW_ADDR     SFC_ROW_ADDR
#define JI_SFC_ROW_ADDR     

#define REG_SFC_STA_ADDR(_n1)   jz_reg(SFC_STA_ADDR(_n1))
#define JA_SFC_STA_ADDR(_n1)    (0xb3440000 + 0x88 + (_n1) * 0x4)
#define JT_SFC_STA_ADDR(_n1)    JIO_32_RW
#define JN_SFC_STA_ADDR(_n1)    SFC_STA_ADDR
#define JI_SFC_STA_ADDR(_n1)    (_n1)

#define REG_SFC_DES_ADDR    jz_reg(SFC_DES_ADDR)
#define JA_SFC_DES_ADDR     (0xb3440000 + 0x90)
#define JT_SFC_DES_ADDR     JIO_32_RW
#define JN_SFC_DES_ADDR     SFC_DES_ADDR
#define JI_SFC_DES_ADDR     

#define REG_SFC_GLB1                jz_reg(SFC_GLB1)
#define JA_SFC_GLB1                 (0xb3440000 + 0x94)
#define JT_SFC_GLB1                 JIO_32_RW
#define JN_SFC_GLB1                 SFC_GLB1
#define JI_SFC_GLB1                 
#define BP_SFC_GLB1_CHIP_SEL        0
#define BM_SFC_GLB1_CHIP_SEL        0x3
#define BF_SFC_GLB1_CHIP_SEL(v)     (((v) & 0x3) << 0)
#define BFM_SFC_GLB1_CHIP_SEL(v)    BM_SFC_GLB1_CHIP_SEL
#define BF_SFC_GLB1_CHIP_SEL_V(e)   BF_SFC_GLB1_CHIP_SEL(BV_SFC_GLB1_CHIP_SEL__##e)
#define BFM_SFC_GLB1_CHIP_SEL_V(v)  BM_SFC_GLB1_CHIP_SEL
#define BP_SFC_GLB1_CHIP1_SEL       31
#define BM_SFC_GLB1_CHIP1_SEL       0x80000000
#define BF_SFC_GLB1_CHIP1_SEL(v)    (((v) & 0x1) << 31)
#define BFM_SFC_GLB1_CHIP1_SEL(v)   BM_SFC_GLB1_CHIP1_SEL
#define BF_SFC_GLB1_CHIP1_SEL_V(e)  BF_SFC_GLB1_CHIP1_SEL(BV_SFC_GLB1_CHIP1_SEL__##e)
#define BFM_SFC_GLB1_CHIP1_SEL_V(v) BM_SFC_GLB1_CHIP1_SEL

#define REG_SFC_DEV1_STA_RT jz_reg(SFC_DEV1_STA_RT)
#define JA_SFC_DEV1_STA_RT  (0xb3440000 + 0x98)
#define JT_SFC_DEV1_STA_RT  JIO_32_RO
#define JN_SFC_DEV1_STA_RT  SFC_DEV1_STA_RT
#define JI_SFC_DEV1_STA_RT  

#define REG_SFC_TRAN_CONF1(_n1)         jz_reg(SFC_TRAN_CONF1(_n1))
#define JA_SFC_TRAN_CONF1(_n1)          (0xb3440000 + 0x9c + (_n1) * 0x4)
#define JT_SFC_TRAN_CONF1(_n1)          JIO_32_RW
#define JN_SFC_TRAN_CONF1(_n1)          SFC_TRAN_CONF1
#define JI_SFC_TRAN_CONF1(_n1)          (_n1)
#define BP_SFC_TRAN_CONF1_TRAN_MD       4
#define BM_SFC_TRAN_CONF1_TRAN_MD       0xf0
#define BF_SFC_TRAN_CONF1_TRAN_MD(v)    (((v) & 0xf) << 4)
#define BFM_SFC_TRAN_CONF1_TRAN_MD(v)   BM_SFC_TRAN_CONF1_TRAN_MD
#define BF_SFC_TRAN_CONF1_TRAN_MD_V(e)  BF_SFC_TRAN_CONF1_TRAN_MD(BV_SFC_TRAN_CONF1_TRAN_MD__##e)
#define BFM_SFC_TRAN_CONF1_TRAN_MD_V(v) BM_SFC_TRAN_CONF1_TRAN_MD

#define REG_SFC_CDT(_n1)    jz_reg(SFC_CDT(_n1))
#define JA_SFC_CDT(_n1)     (0xb3440000 + 0x800 + (_n1) * 0x4)
#define JT_SFC_CDT(_n1)     JIO_32_RW
#define JN_SFC_CDT(_n1)     SFC_CDT
#define JI_SFC_CDT(_n1)     (_n1)

#endif /* __HEADERGEN_X1600_SFC_H__*/
