 ...
 *
 ****************************************************************************/
#ifndef __HEADERGEN_X1600_I2C_H__
#define __HEADERGEN_X1600_I2C_H__

#include "macro.h"

#define REG_I2C_CON(_n1)            jz_reg(I2C_CON(_n1))
#define JA_I2C_CON(_n1)             (0xb0050000 + 0x0 + (_n1) * 0x1000)
...
#define BV_I2C_CON_SPEED__3400K     0x3
...
#define JA_I2C_DC(_n1)          (0xb0050000 + 0x10 + (_n1) * 0x1000)
...
#define JA_I2C_INTST(_n1)           (0xb0050000 + 0x2c + (_n1) * 0x1000)
...
#define JA_I2C_INTMSK(_n1)          (0xb0050000 + 0x30 + (_n1) * 0x1000)
...
#define JA_I2C_RINTST(_n1)          (0xb0050000 + 0x34 + (_n1) * 0x1000)
...
#define JA_I2C_ENABLE(_n1)          (0xb0050000 + 0x6c + (_n1) * 0x1000)
...
#define JA_I2C_STATUS(_n1)          (0xb0050000 + 0x70 + (_n1) * 0x1000)
...
#define JA_I2C_ENBST(_n1)           (0xb0050000 + 0x9c + (_n1) * 0x1000)
...
#define JA_I2C_TAR(_n1)                 (0xb0050000 + 0x4 + (_n1) * 0x1000)
...
#define JA_I2C_SAR(_n1)     (0xb0050000 + 0x8 + (_n1) * 0x1000)
...
#define JA_I2C_SHCNT(_n1)   (0xb0050000 + 0x14 + (_n1) * 0x1000)
...
#define JA_I2C_SLCNT(_n1)   (0xb0050000 + 0x18 + (_n1) * 0x1000)
...
#define JA_I2C_FHCNT(_n1)   (0xb0050000 + 0x1c + (_n1) * 0x1000)
...
#define JA_I2C_FLCNT(_n1)   (0xb0050000 + 0x20 + (_n1) * 0x1000)
...
#define JA_I2C_RXTL(_n1)    (0xb0050000 + 0x38 + (_n1) * 0x1000)
...
#define JA_I2C_TXTL(_n1)    (0xb0050000 + 0x3c + (_n1) * 0x1000)
...
#define JA_I2C_TXFLR(_n1)   (0xb0050000 + 0x74 + (_n1) * 0x1000)
...
#define JA_I2C_RXFLR(_n1)   (0xb0050000 + 0x78 + (_n1) * 0x1000)
...
#define JA_I2C_SDAHD(_n1)   (0xb0050000 + 0x7c + (_n1) * 0x1000)
...
#define JA_I2C_ABTSRC(_n1)  (0xb0050000 + 0x80 + (_n1) * 0x1000)
...
#define JA_I2C_DMACR(_n1)   (0xb0050000 + 0x88 + (_n1) * 0x1000)
...
#define JA_I2C_DMATDLR(_n1)     (0xb0050000 + 0x8c + (_n1) * 0x1000)
...
#define JA_I2C_DMARDLR(_n1)     (0xb0050000 + 0x90 + (_n1) * 0x1000)
...
#define JA_I2C_SDASU(_n1)   (0xb0050000 + 0x94 + (_n1) * 0x1000)
...
#define JA_I2C_ACKGC(_n1)   (0xb0050000 + 0x98 + (_n1) * 0x1000)
...
#define JA_I2C_FLT(_n1)     (0xb0050000 + 0xa0 + (_n1) * 0x1000)
...
#define JA_I2C_CINT(_n1)    (0xb0050000 + 0x40 + (_n1) * 0x1000)
...
#define JA_I2C_CRXUF(_n1)   (0xb0050000 + 0x44 + (_n1) * 0x1000)
...
#define JA_I2C_CRXOF(_n1)   (0xb0050000 + 0x48 + (_n1) * 0x1000)
...
#define JA_I2C_CTXOF(_n1)   (0xb0050000 + 0x4c + (_n1) * 0x1000)
...
#define JA_I2C_CRXREQ(_n1)  (0xb0050000 + 0x50 + (_n1) * 0x1000)
...
#define JA_I2C_CTXABT(_n1)  (0xb0050000 + 0x54 + (_n1) * 0x1000)
...
#define JA_I2C_CRXDN(_n1)   (0xb0050000 + 0x58 + (_n1) * 0x1000)
...
#define JA_I2C_CACT(_n1)    (0xb0050000 + 0x5c + (_n1) * 0x1000)
...
#define JA_I2C_CSTP(_n1)    (0xb0050000 + 0x60 + (_n1) * 0x1000)
...
#define JA_I2C_CSTT(_n1)    (0xb0050000 + 0x64 + (_n1) * 0x1000)
...
#define JA_I2C_CGC(_n1)     (0xb0050000 + 0x68 + (_n1) * 0x1000)
#define JT_I2C_CGC(_n1)     JIO_32_RW
#define JN_I2C_CGC(_n1)     I2C_CGC
#define JI_I2C_CGC(_n1)     (_n1)

#define REG_I2C_HS_MADDR(_n1)       jz_reg(I2C_HS_MADDR(_n1))
#define JA_I2C_HS_MADDR(_n1)        (0xb0050000 + 0xc + (_n1) * 0x1000)
#define JT_I2C_HS_MADDR(_n1)        JIO_32_RW
#define JN_I2C_HS_MADDR(_n1)        I2C_HS_MADDR
#define JI_I2C_HS_MADDR(_n1)        (_n1)
#define BP_I2C_HS_MADDR_HSMAR       0
#define BM_I2C_HS_MADDR_HSMAR       0x7
#define BF_I2C_HS_MADDR_HSMAR(v)    (((v) & 0x7) << 0)
#define BFM_I2C_HS_MADDR_HSMAR(v)   BM_I2C_HS_MADDR_HSMAR
#define BF_I2C_HS_MADDR_HSMAR_V(e)  BF_I2C_HS_MADDR_HSMAR(BV_I2C_HS_MADDR_HSMAR__##e)
#define BFM_I2C_HS_MADDR_HSMAR_V(v) BM_I2C_HS_MADDR_HSMAR

#define REG_I2C_HHCNT(_n1)  jz_reg(I2C_HHCNT(_n1))
#define JA_I2C_HHCNT(_n1)   (0xb0050000 + 0x24 + (_n1) * 0x1000)
#define JT_I2C_HHCNT(_n1)   JIO_32_RW
#define JN_I2C_HHCNT(_n1)   I2C_HHCNT
#define JI_I2C_HHCNT(_n1)   (_n1)

#define REG_I2C_HLCNT(_n1)  jz_reg(I2C_HLCNT(_n1))
#define JA_I2C_HLCNT(_n1)   (0xb0050000 + 0x28 + (_n1) * 0x1000)
#define JT_I2C_HLCNT(_n1)   JIO_32_RW
#define JN_I2C_HLCNT(_n1)   I2C_HLCNT
#define JI_I2C_HLCNT(_n1)   (_n1)

#define REG_I2C_SDNACK(_n1) jz_reg(I2C_SDNACK(_n1))
#define JA_I2C_SDNACK(_n1)  (0xb0050000 + 0x84 + (_n1) * 0x1000)
#define JT_I2C_SDNACK(_n1)  JIO_32_RW
#define JN_I2C_SDNACK(_n1)  I2C_SDNACK
#define JI_I2C_SDNACK(_n1)  (_n1)

#endif /* __HEADERGEN_X1600_I2C_H__*/
