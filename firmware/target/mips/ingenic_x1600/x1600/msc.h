 ...
 *
 ****************************************************************************/
#ifndef __HEADERGEN_X1600_MSC_H__
#define __HEADERGEN_X1600_MSC_H__

#include "macro.h"

#define REG_MSC_CTRL(_n1)                   jz_reg(MSC_CTRL(_n1))
#define JA_MSC_CTRL(_n1)                    (0xb3450000 + 0x0 + (_n1) * 0x10000)
...
#define JA_MSC_STAT(_n1)                        (0xb3450000 + 0x4 + (_n1) * 0x10000)
...
#define JA_MSC_CMDAT(_n1)               (0xb3450000 + 0xc + (_n1) * 0x10000)
...
#define JA_MSC_IMASK(_n1)                   (0xb3450000 + 0x24 + (_n1) * 0x10000)
...
#define JA_MSC_IFLAG(_n1)                   (0xb3450000 + 0x28 + (_n1) * 0x10000)
...
#define JA_MSC_LPM(_n1)                                 (0xb3450000 + 0x40 + (_n1) * 0x10000)
...
#define BP_MSC_LPM_SMP_SEL                              29
#define BM_MSC_LPM_SMP_SEL                              0x20000000
#define BV_MSC_LPM_SMP_SEL__RISE_EDGE                   0x0
#define BV_MSC_LPM_SMP_SEL__RISE_EDGE_DELAYED           0x1
#define BF_MSC_LPM_SMP_SEL(v)                           (((v) & 0x1) << 29)
...
#define JA_MSC_DMAC(_n1)                (0xb3450000 + 0x44 + (_n1) * 0x10000)
...
#define JA_MSC_CTRL2(_n1)                   (0xb3450000 + 0x58 + (_n1) * 0x10000)
...
#define JA_MSC_CLKRT(_n1)   (0xb3450000 + 0x8 + (_n1) * 0x10000)
...
#define JA_MSC_RESTO(_n1)   (0xb3450000 + 0x10 + (_n1) * 0x10000)
...
#define JA_MSC_RDTO(_n1)    (0xb3450000 + 0x14 + (_n1) * 0x10000)
...
#define JA_MSC_BLKLEN(_n1)  (0xb3450000 + 0x18 + (_n1) * 0x10000)
...
#define JA_MSC_NOB(_n1)     (0xb3450000 + 0x1c + (_n1) * 0x10000)
...
#define JA_MSC_SNOB(_n1)    (0xb3450000 + 0x20 + (_n1) * 0x10000)
...
#define JA_MSC_CMD(_n1)     (0xb3450000 + 0x2c + (_n1) * 0x10000)
...
#define JA_MSC_ARG(_n1)     (0xb3450000 + 0x30 + (_n1) * 0x10000)
...
#define JA_MSC_RES(_n1)     (0xb3450000 + 0x34 + (_n1) * 0x10000)
...
#define JA_MSC_RXFIFO(_n1)  (0xb3450000 + 0x38 + (_n1) * 0x10000)
...
#define JA_MSC_TXFIFO(_n1)  (0xb3450000 + 0x3c + (_n1) * 0x10000)
...
#define JA_MSC_DMANDA(_n1)  (0xb3450000 + 0x48 + (_n1) * 0x10000)
...
#define JA_MSC_DMADA(_n1)   (0xb3450000 + 0x4c + (_n1) * 0x10000)
...
#define JA_MSC_DMALEN(_n1)  (0xb3450000 + 0x50 + (_n1) * 0x10000)
...
#define JA_MSC_DMACMD(_n1)  (0xb3450000 + 0x54 + (_n1) * 0x10000)
