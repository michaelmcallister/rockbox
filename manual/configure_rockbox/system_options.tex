  ...
  \begin{description}
    ...
    \opt{usb_power}{
      \item[USB Mode]
        ...
        using the player). You can choose the opposite behavior by holding down
        \opt{hibyr1native}{\ActionStdUsbCharge{}}%
        \nopt{hibyr1native}{any button} while plugging in the USB cable.
        \nopt{fuzeplus}{
