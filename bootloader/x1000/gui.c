...
/* Panel bring-up only.  The screen primitives, the splash and the list widget
 * moved to bootloader/ingenic/gui-ingenic.c, shared with the X1600; these two
 * stay per target because that is where the SoCs actually differ. */
